...
The screenshot collector therefore continues to preserve the original capture bytes unchanged. Annotation and proposed-redaction data are separate structured layers that refer to the immutable original by SHA-256 digest and original dimensions.
